...
def densenetfcn(height, width, channels, classes, features=64, depth=4,
         temperature=1.0, padding='valid', batchnorm=False, dropout=0.0):
    model=DenseNetFCN((512,512,channels),growth_rate=12, nb_layers_per_block=[4, 4, 4, 4, 4, 4], upsampling_type='deconv',classes=classes)
    return model
...
if __name__ == '__main__':
    ...
    model = DenseNetFCN((32, 32, 3), growth_rate=12, nb_layers_per_block=[4, 4, 4, 4, 4, 4], upsampling_type='deconv')
